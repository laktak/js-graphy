...
(function($, undefined) {
    ...
    $.fn.split = function(options) {
        ...
        function trResize(el, silent) {
          if (!silent) el.find('.splitter_panel').trigger('splitter.resize');
          that.trigger('split.resize');
        }
